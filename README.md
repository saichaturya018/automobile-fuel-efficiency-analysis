...
Git
Setup Steps 1. Clone the repository: git clone https://github.com/saichaturya018/Fuel-Efficiency-MPG-Prediction.git
cd Fuel-Efficiency-MPG-Prediction
...
4. Run Model Training & Diagnostics: python src/train_rf.py
